...
bStdMetric["color"] = pgvar.UI_button_selected_color						
...
bStdImperial["color"] = pgvar.UI_button_disabled						
bStdImperial["group"] = "Standard"							
bStdImperial["visible"] = True		
bStdImperial["available"] = False
...
b2D["enabled"] = True											# buttonEnabled
b2D["color"] = pgvar.UI_button_selected_color					# buttonColor
...
bCalc1D["color"] = pgvar.UI_button_disabled							# buttonColor
bCalc1D["group"] = "calculationDimesions"							# buttonGroup
bCalc1D["visible"] = True											# buttonVisible
bCalc1D["available"] = False										# this flag if False will render the button dark
...
bCalc2D["color"] = pgvar.UI_button_selected_color					# buttonColor
bCalc2D["group"] = "calculationDimesions"							# buttonGroup
bCalc2D["visible"] = True											# buttonVisible
bCalc2D["available"] = True 										# this flag if False will render the button dark
...
bCalc3D["color"] = pgvar.UI_button_disabled							# buttonColor
bCalc3D["group"] = "calculationDimesions"							# buttonGroup
bCalc3D["visible"] = True											# buttonVisible
bCalc3D["available"] = False 										# this flag if False will render the button dark
...
mInsertoption04["label_txt"] = " Atom / Element "					# button_label_txt
